...
Podría agregar una nueva propiedad de `edad` al objeto de `userProfile` anidado con: You could add a new `edad` property to the nested `userProfile` object with:
